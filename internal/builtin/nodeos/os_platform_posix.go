...
// os 平台共享实现（POSIX：Linux/macOS/BSD）：
// 空设备/TTY 判定/fs 常量/用户信息/优先级 与 /proc 读取（非 Linux 返回零值）。
// uname 系列因 darwin 无 syscall.Utsname 分平台实现
// （os_platform_unix.go / os_platform_darwin.go）。
